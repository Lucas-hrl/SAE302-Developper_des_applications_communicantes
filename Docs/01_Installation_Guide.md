...
3. [Configuration Environnement Python](#python)
4. [Installation MariaDB](#mariadb)
...
│
├── env/                              # Environnement virtuel (créé localement dans l'étape suivante)
│   ├── lib/
...
│
└── Prototypes/                       # Codes de test et anciennes versions des codes finaux (Développement)
```

### 2.3 Vérification des Fichiers Critiques
...
# PyQt6                    6.6.0 (ou autre version)
# mysql-connector-python   8.2.0 (ou autre version)
```

---

## 4. Installation et Configuration MariaDB {#mariadb}
...
### 4.2 Création de l'Utilisateur et des Droits d'Accès
