...
from routeur_crypt import Routeur, obtenir_ip, s_inscrire_au_master
...
def lancer_un_routeur(ip_routeur, port_routeur, ip_master, port_master):
    ...
    if s_inscrire_au_master(ip_master, port_master, port_routeur, cle):
        ...
        print(f"[!] Routeur démarré sur {ip_routeur}:{port_routeur} mais ECHEC inscription Master (Isolé)")
